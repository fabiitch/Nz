...
//
//public class OldQ2<T> implements Pool.Poolable {
//
//    public OldQ2<T> parent, ne, nw, se, sw;
...
//    }
//
//    public OldQ2(Rectangle rect, int maxValues, int maxDepth) {
//        this(null, rect, maxValues, maxDepth, new QuadPools<>());
//    }
//
//    public OldQ2(Rectangle rect, int maxValues, int maxDepth, QuadPools<T> quadPools) {
//        this(null, rect, maxValues, maxDepth, quadPools);
//    }
//
//    protected OldQ2(OldQ2<T> parent, Rectangle rect, int maxValues, int maxDepth, QuadPools<T> quadPools) {
//        this.parent = parent;
...
//    }
//
//    private void set(OldQ2<T> parent, Rectangle rectangle, int maxValues, int maxDepth, QuadPools<T> quadPools) {
//        this.parent = parent;
...
//    }
//
//    public OldQ2<T> add(T value, Rectangle rect) {
//        OldQ2<T> quad = getQuad(rect);
//        if (quad != null) {
//            if (quad.shouldSplit()) {
//                quad.split();
...
//    }
//
//    public OldQ2<T> update(T value, Rectangle rectangle) {
//        OldQ2<T> quad = getQuad(rectangle);
//        if (quad != this) {
//            remove(value);
//            add(value, rectangle);
//        }
...
//    }
//
//    public OldQ2<T> getQuad(Rectangle rectangle) {
//        if (RectangleUtils.containsStick(this.boundingRect, rectangle)) {
//            if (!isSplit())
//                return this;
//            OldQ2<T> child = nw.getQuad(rectangle);
//            if (child != null)
//                return child;
...
//
//
//    public OldQ2<T> getQuad(Vector2 pos) {
//        return getQuad(pos.x, pos.y);
//    }
//
//    public OldQ2<T> getQuad(float x, float y) {
//        if (RectangleUtils.containsStick(this.boundingRect, x, y)) {
//            if (!isSplit())
//                return this;
//            OldQ2<T> child = nw.getQuad(x, y);
//            if (child != null)
//                return child;
