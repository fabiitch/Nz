package com.fabiitch.nz.java.math.path.rectangle.corridor;

import com.badlogic.gdx.math.Vector2;
import com.badlogic.gdx.utils.Pool;
import com.fabiitch.nz.java.math.utils.direction.Direction;
import com.fabiitch.nz.java.math.utils.direction.Orientation;
...
public class CorridorPathStep implements Pool.Poolable {
    ...
    public CorridorPathStep(Direction direction, float length, float walkSize, float wallSize) {
    ...
    public float getTotalSize() {
        return walkSize + wallSizeA + wallSizeB;
    }
